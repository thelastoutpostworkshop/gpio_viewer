...
- v3.2.1 [ESP32 Arduino Core](https://github.com/espressif/arduino-esp32)
- v3.4.5 [Async TCP](https://github.com/mathieucarbou/AsyncTCP)
- v3.7.9 [ESP Async WebServer](https://github.com/mathieucarbou/ESPAsyncWebServer)
