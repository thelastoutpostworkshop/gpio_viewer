...
- v3.1.3 [ESP32 Arduino Core](https://github.com/espressif/arduino-esp32)
- v3.3.6 [Async TCP](https://github.com/mathieucarbou/AsyncTCP)
- v3.7.2 [ESP Async WebServer](https://github.com/mathieucarbou/ESPAsyncWebServer)
